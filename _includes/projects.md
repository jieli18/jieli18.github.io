...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title">Application of Nonlinear Robust Reinforcement Learning in Intelligent Vehicle Control</div>
    <div class="periodical">Nov 2023</div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/model-based_idc.gif" class="teaser img-fluid z-depth-1">
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title">Model-Based Integrated Decision and Control of Intelligent Vehicles in Urban Scenarios</div>
    <div class="periodical">Oct 2021</div>
  </div>
</div>
</li>
